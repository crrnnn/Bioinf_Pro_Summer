...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 21 20:57:17 2018
...
##############################################################################################
# Create train and test sets for decision tree, calculate the scores,  for single sequence information
##############################################################################################
print()
...
param_dist = {"max_depth" : [None,1, 5, 10, 15, 20, 25, 30],
              "criterion": ["gini", "entropy"],
              "min_samples_split" : [2,4,6,8,10,12,17],
...
#%% 
#################################################################################################################   
# Create train and test sets for decision tree, calculate the scores,  multiple sequence substutition matrix information 
#################################################################################################################    
print()
...
#%% 
###########################################################################################    
# Create train and test sets for decision tree, calculate the scores,  frequency matrix information  
###########################################################################################
print()
